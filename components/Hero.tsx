    ...
    >
      <div className="mx-auto max-w-[1440px] px-6 pb-12 pt-20 sm:pt-24 md:px-12 md:pb-20 md:pt-36">
        <div className="mx-auto max-w-[1100px] text-center">
          ...
          <p className="mx-auto mt-10 max-w-2xl text-lg font-medium leading-[1.8] text-[var(--text)] sm:mt-12 sm:text-xl md:mt-14 md:text-2xl md:leading-relaxed">
            브랜딩부터 간판까지,
            <br className="sm:hidden" />
            오래 기억되는 브랜드 경험을 만듭니다.
          </p>

          <div className="mt-9 flex flex-wrap items-center justify-center gap-3 sm:mt-10 md:mt-12">
            <Link
              href="/portfolio"
