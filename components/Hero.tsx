    ...
    >
      <div className="mx-auto max-w-[1440px] px-6 pb-12 pt-12 sm:pt-16 md:px-12 md:pb-20 md:pt-28">
        <div className="mx-auto max-w-[1200px] text-center">
          <p className="hero-eyebrow text-[10px] font-semibold tracking-[0.24em] text-[var(--muted)] sm:text-xs sm:tracking-[0.3em] md:text-sm">
            BRANDING & SIGNAGE DESIGN STUDIO
          </p>

          <h1 className="hero-title mt-5 text-[3rem] font-semibold leading-[1.06] tracking-[-0.06em] text-[var(--text-dark)] sm:text-6xl sm:leading-[1.02] md:text-8xl lg:text-[7.5rem]">
            Design that stays.
            <br />
            Not just looks.
          </h1>

          <div className="hero-description mt-14 flex justify-center sm:mt-16 md:mt-20">
          ...
          <div className="hero-buttons mt-10 flex flex-wrap items-center justify-center gap-3 md:mt-12">
            <Link
              href="/portfolio"
        ...
        <div className="hero-image relative mt-14 overflow-hidden rounded-[28px] bg-[#ded7cb] sm:mt-16 md:mt-24 md:rounded-[44px]">
          <div className="relative aspect-[4/5] sm:aspect-[16/10] lg:aspect-[16/8]">
            <Image
              ...
              className="object-cover transition-transform duration-[1400ms] hover:scale-[1.015]"
            />
